#!/usr/bin/env python3
"""
dispute_agent.py — dispute/refund automation layer for the bank.mcp suite.
...
def check_for_resolutions(transactions, *, path=None):
    ...
    from bank_mcp.engines.receipt_scanner import merchant_similarity
...
def render_status(disputes=None, *, path=None):
    ...
    L = []
    L.append("# bank.mcp - DISPUTE STATUS")
...
def main():
    ...
    ap = argparse.ArgumentParser(
        description="Dispute/refund automation for the bank.mcp suite.")

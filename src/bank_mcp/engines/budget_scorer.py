...
from bank_mcp.store import subscription_creep as sc   # reuse grouping / cadence / dup logic
from bank_mcp.store import obligation_registry as oblreg  # ending obligations free up cash
...
def main():
    ...
    if a.email is not None:
        ...
        subj = f"bank.mcp — {'Weekly Pulse' if mode=='weekly' else 'Monthly Check-In'} {s['window']['end']}"

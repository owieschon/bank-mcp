"""db.py — the canonical local datastore for bank.mcp.
...
from bank_mcp.store import subscription_creep as sc   # canonical accessors — store what engines compute
from bank_mcp import money                            # exact integer-cents conversion

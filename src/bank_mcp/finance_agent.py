#!/usr/bin/env python3
"""
finance_agent.py — the UNIFIED runner for the bank.mcp finance-agent suite.
...
def render(digest):
    ...
    L.append(f"# bank.mcp — UNIFIED {head} DIGEST")
...
def main():
    ap = argparse.ArgumentParser(
        description="Unified bank.mcp finance digest (forecast + budget + "
                    "fee/fraud + recurring).")
